label scene_4:
    ...
    i "{b}Да я не хочу успокаиваться, я хочу спать и чтобы мне привели Макара!{/b}"

    sk "Он же не один вышел, а со всеми, ничего с ним не случится"
    ...
    i "Так и {u}что делать{/u}-то?"

    m "Можно ему девушку найти, чтобы она его раскачивала"
